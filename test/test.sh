...
CMD="${SCRIPT_DIR}/../assets/hisat2-align-gf2.sh"
    CMD="${CMD} --input=\"${SCRIPT_DIR}/data/reads/sample_1.fq\""
    CMD="${CMD} --pair=\"${SCRIPT_DIR}/data/reads/sample_2.fq\""
    CMD="${CMD} --reference=\"${SCRIPT_DIR}/data/reference\""
    CMD="${CMD} --threads=\"2\""
